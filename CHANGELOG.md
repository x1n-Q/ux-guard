...
- Installed the CLI into a temporary action directory before running scans, avoiding `npx`
  workspace shadowing when ux-guard dogfoods itself or runs inside npm monorepos.
